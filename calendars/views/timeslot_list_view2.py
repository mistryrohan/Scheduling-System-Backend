...
from calendars.serializers.timeslot_serializer2 import TimeslotSerializer2
from rest_framework.exceptions import PermissionDenied

class TimeslotListView2(APIView):
    """
    ...
    def get(self, request, calendar_id):
        ...
        serializer = TimeslotSerializer2(timeslots, many=True)
    ...
    def post(self, request, calendar_id):
        ...
        for slot_data in data['timeslots']: 
            ...
            serializer = TimeslotSerializer2(data=slot_data)
