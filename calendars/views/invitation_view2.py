...
from calendars.serializers.invitee_serializer2 import InviteeSerializer2
...
class InvitationView2(APIView):
    ...
    def get(self, request, calendar_id):
        ...
        responded_invitees_serializer = InviteeSerializer2(responded_invitees, many=True)
    ...
    def post(self, request, calendar_id):
        ...
        for user_id in user_ids:
            ...
            serializer = InviteeSerializer2(data=data)
